...
public class NumberProgressBar extends View {
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            setProgressTextVisibility(bundle.getBoolean(INSTANCE_TEXT_VISIBILITY) ? com.xuexiang.xupdate.widget.NumberProgressBar.ProgressTextVisibility.VISIBLE : com.xuexiang.xupdate.widget.NumberProgressBar.ProgressTextVisibility.INVISIBLE);
    ...
    public void setProgressTextVisibility(com.xuexiang.xupdate.widget.NumberProgressBar.ProgressTextVisibility visibility) {
        mIfDrawText = visibility == com.xuexiang.xupdate.widget.NumberProgressBar.ProgressTextVisibility.VISIBLE;
        postInvalidate();
    }

    public void setOnProgressBarListener(com.xuexiang.xupdate.widget.NumberProgressBar.OnProgressBarListener listener) {
        mListener = listener;
    }
